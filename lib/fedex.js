...
class Fedex {
    constructor() {
        ...
        this.rateAndTransitTime = (data) => __awaiter(this, void 0, void 0, function* () {
            try {
                const token = yield this.generateToken(data.credentials);
        ...
        this.cancelShipment = (data) => __awaiter(this, void 0, void 0, function* () {
            try {
                const token = yield this.generateToken(data.credentials);
                ...
                const response = yield axios_1.default.put(url, body, {
                    headers: {
                        "Content-Type": 'application/json',
                        Authorization: `Bearer ${token}`,
                        'x-customer-transaction-id': '',
        ...
        this.trackByTrackingNumber = (data) => __awaiter(this, void 0, void 0, function* () {
            try {
                const token = yield this.generateToken(data.credentials);
        ...
        this.validatePostal = (data) => __awaiter(this, void 0, void 0, function* () {
            try {
                const token = yield this.generateToken(data.credentials);
                const url = 'https://apis-sandbox.fedex.com/rate/v1/rates/quotes';
                const body = {
        ...
        this.checkPickupAvailability = (data) => __awaiter(this, void 0, void 0, function* () {
            try {
                const token = yield this.generateToken(data.credentials);
